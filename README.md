# PROJECT_PICO8
This is a [PICO-8](https://www.lexaloffle.com/pico-8.php) game project in progress on and off. I chose this very loose, lightweight, C-like engine to challenge myself with building systems and features of a game engine from scratch including collision detection and filtering, object class inheritance and flexibility, sprite parsing and animation systems, and OOP management.
